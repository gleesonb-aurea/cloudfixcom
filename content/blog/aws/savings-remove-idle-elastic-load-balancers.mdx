...
\[caption id="attachment\_12483" align="alignnone" width="1024"\]![Wiliam Wallace Braveheart “Freedom” meme image.](/media/uploads/Freedom-from-paying-too-much-for-Elastic-Load-Balancers.jpg) Freedom… from paying too much for Elastic Load Balancers\[/caption\]
...
\[caption id="attachment\_12481" align="aligncenter" width="1819"\]![An image showing an AWS Elastic Load Balancer routing a load to 3 EC2 instances](/media/uploads/Diagram-A-typical-configuration-of-an-ELB-and-EC2-instances.png) A typical configuration of an ELB and EC2 instances\[/caption\]
...
\[caption id="attachment\_12482" align="alignnone" width="1999"\]![A flow chart showing how to find and remove idle ELBs](/media/uploads/Diagram-How-to-find-and-remove-idle-Elastic-Load-Balancers.png) How to find and remove idle Elastic Load Balancers\[/caption\]
