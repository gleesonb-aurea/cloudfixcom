...
\[caption id="attachment\_12728" align="alignnone" width="800"\]![This is a process flowchart to show how we decide which trail to delete](/media/uploads/Diagram-Algorithm-to-eliminate-a-redundant-trail-min.png) A five-step process for manually deactivating redundant AWS CloudTrail trails\[/caption\]
